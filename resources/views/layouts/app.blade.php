        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                @auth
                    ...
                    <li class="dropdown"><a href="#"><i class='bx bxs-user'></i><span>{{Auth::user()->name}}</span> @isset(Auth::user()->img)<img src="{{asset('/public/images/'.Auth::user()->img)}}" alt="" class="profile-photo">@endisset <i
